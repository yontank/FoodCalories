...
class YehidotMida(Base):
    ...
    smlmida: Mapped[int] = mapped_column(SmallInteger, primary_key=True, nullable=False)
    shmmida: Mapped[str] = mapped_column(String(30))

    meals: Mapped[list["MealsEaten"]] = (  # pyright: ignore[reportUndefinedVariable]
        relationship(back_populates="mida", overlaps="meal_mishkal")
    )
